...
def set_model():
	he = initializers.he_uniform(seed=1)

	inputs  = Input(shape=(340,))
	encoded = Dense(272, activation='relu', kernel_initializer=he, use_bias=True, bias_initializer='zeros')(inputs)
	encoded = Dense(204, activation='relu', kernel_initializer=he, use_bias=True, bias_initializer='zeros')(encoded)
	encoded = Dense(136, activation='relu', kernel_initializer=he, use_bias=True, bias_initializer='zeros')(encoded)
	encoded = Dense(68,  activation='relu', kernel_initializer=he, use_bias=True, bias_initializer='zeros')(encoded)
	...
	adagrad = optimizers.Adagrad(lr=0.0128, epsilon=1e-11, decay=1e-13)
